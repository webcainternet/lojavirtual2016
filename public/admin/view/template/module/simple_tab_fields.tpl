                ...
                <htab title="<?php echo $l->get('tab_field_main', true) ?>" title-lang-id="tab_field_main">
                    <table class="form">
                        ...
                        <tr ng-if="inArray(field.type, typesWithValues)" ng-init="field.values = !empty(field.values) ? field.values : {}">
                            ...
                            <td>
                                <div ng-if="field.values.source == 'saved'" ng-init="field.values.saved = !empty(field.values.saved) ? field.values.saved : {}">
                                    <div ng-repeat="l in languages"><img style="vertical-align:top;" ng-src="view/image/flags/{{l.image}}" />&nbsp;<textarea ng-model="field.values.saved[l.code]" ng-keyup="parseValues(field.id, l.code, field.values.saved[l.code])" cols="100" placeholder="Example: value1=text1;value2=text2;value3=text3"></textarea></div>
                                </div>
                        ...
                        <tr ng-if="field.custom" ng-init="field.sync = !empty(field.sync) ? field.sync : false">
                            ...
                            <td><input type="checkbox" ng-model="field.sync"></td>
                        </tr>
                    </table>
                </htab>
