    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <?php 
            if ($model == "Loja Virtual Profissional") {
        ...
        <div class="<?php echo $class; ?>">
          ...
          <?php switch ($heading_title) {
            case 'Loja Virtual Profissional':
              ?><h1><b>Loja Virtual</b> <span class="wca-font wca-amarela">Profissional</span></h1><?php
              break;
            
            case 'Loja Virtual Service':
              ?><h1><b>Loja Virtual</b> <span class="wca-font wca-amarela">Service</span></h1><?php
              break;
          ...
          <div class="form-group">
              ...
              <?php 
                ...
                <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block">Solicitar Orçamento</button>
