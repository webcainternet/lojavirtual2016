  ...
  <div class="container">
    ...
    <div id="top-links" class="nav pull-right">
      <ul class="list-inline">
        <li>
          <a href="/painel" target="_blank" title="painel" class="dropdown-toggle" data-toggle="dropdown">
            <i class="fa fa-cog"></i> 
            <span class="hidden-xs hidden-sm hidden-md">Painel de Controle</span>
          </a>
        </li>
        <li>
          <a href="/webmail" target="_blank" title="webmail" class="dropdown-toggle" data-toggle="dropdown">
