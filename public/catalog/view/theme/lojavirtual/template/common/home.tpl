    ...
    <div class="container">
      ...
      <div class="row advantages">
          <div class="wcainclusoitem" data-toggle="tooltip-advantages" title="">
              <img src="/image/check.png" style="width: 50px; margin-top: 8px;"><h4 class="wcainclusotitulo"><b>Vídeos de apoio</b><br> De acordo com o seu bolso</h4>
          </div>

          <div class="wcainclusoitem" data-toggle="tooltip-advantages" title="">
              <img src="/image/check.png" style="width: 50px; margin-top: 8px;"><h4 class="wcainclusotitulo"><b>Suporte e manutenção</b><br> Suporte técnico ao /admin via telefone</h4>
          </div>

          <div class="wcainclusoitem" data-toggle="tooltip-advantages" title="">
              <img src="/image/check.png" style="width: 50px; margin-top: 8px;"><h4 class="wcainclusotitulo"><b>Documentação</b><br> Manual completo de uso do serviço</h4>
          </div>
          <div class="wcainclusoitem" data-toggle="tooltip-advantages" title="">
              <img src="/image/check.png" style="width: 50px; margin-top: 8px;"><h4 class="wcainclusotitulo"><b>Vídeos de apoio</b><br> De acordo com o seu bolso</h4>
          </div>
